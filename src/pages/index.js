                ...
                <div className={style.ContentWrapper}>
                    <div className={style.Left}>
                        {
                            selectedPhoto ?
                                <div style={{marginBottom: '90px'}}>
                                    <InfoPanel photoData={selectedPhotoCall['data']} onClose={() => setSelectedPhoto(undefined)} />
                                </div>
                            :
                                <div style={{marginBottom: '90px'}}>
                                    {
                    ...
                    <div className={style.Right}>
                        <div className={style.RightSideWrapper}>
                            <MapComponent photoData={selectedPhotoCall['data']}/>
                        </div>
                    </div>
                </div>
