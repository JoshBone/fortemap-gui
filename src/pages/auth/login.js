...
const LoginPage = () => {
    ...
    const onFinish = async(values) => {
        ...
        if (response.error) {
            switch (response.error) {
                case 'serverProblem':
                    setLoginError('Szerver probléma. Kérlek, próbáld meg újra később!');
                    break;
                case 'badCredentials':
                    setLoginError('A belépési adataid helytelenek. Kérlek, próbáld meg újra!');
                    break;
            }
            setLoading(false);
        } else {
    ...
    return (
        <>
            <Head>
                <title>Fortemap Geotagger - Belépés</title>
            </Head>
                    ...
                    >
                        <div style={{ width: '100%', maxWidth: '400px', textAlign: 'center' }}>
                            ...
                            <div style={{marginBottom: '24px'}}>
                                <svg className="header-nav__logo" xmlns="http://www.w3.org/2000/svg" width="128" height="80"
                                     viewBox="0 0 64 40">
                                    <path fill="#F73F13"
                            ...
                            >
                                <Form.Item
                                    ...
                                    name="username"
                                    rules={[{required: true, message: 'Kérlek, írd be a felhasználóneved!'}]}
                                >
                                    <Input/>
                                </Form.Item>
                                ...
                                <Form.Item
                                    label="Jelszó"
                                    name="password"
                                    rules={[{required: true, message: 'Kérlek, írd be a jelszavadat!'}]}
                                >
                                    <Input.Password/>
                                </Form.Item>
                                <br/>
